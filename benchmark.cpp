...
static void bench_map_filter_sum() {
    auto bench = Bench()
...
static void bench_join_split() {
    auto bench = Bench()
        .title("join_with-split")
        .relative(true);
...
static void bench_join_to_string() {
    auto bench = Bench()
...
static void bench_map_size_sum() {
    auto bench = Bench()
        .title("map-size-sum")
        .relative(true);
